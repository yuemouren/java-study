		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" onsubmit="return check(this)" method="post" action="${pageContext.request.contextPath}/user/getOne">						
						<input type="hidden" name="method" value="login">						
						<div class="form-group">
							<label for="username" class="col-sm-2 control-label">用户名</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username" value="${info[0]}"  name="username"  placeholder="请输入用户名">
							</div>
						</div>
