...
<head>
    ...
    <script type="application/javascript" charset="UTF-8">
        $(function () {
            $.ajax({
                type: "GET",
                url: "employee/getSendEmpAndEmail",
                dataType: "json",
                success: function (data) {
                    $(data.emails).each(function (index, item) {
                        var recive = "";
                        if (item.lookState == 0) {
                            recive = "<a href='message-receive.jsp?name=" + item.employee.ename + "&id=" + item.employee.eid + "&eid=" + item.id + "'>回复</a>|";
                        }
                        var newDate = new Date(item.sendtime);
                        ...
                        var tr = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                            ...
                            "\t<td>" + item.id + "</td>\n" +
                            "\t<td>" + item.title + "</td>\n" +
                            "\t<td align=\"center\"><span>" + item.content + "</span></td>\n" +
