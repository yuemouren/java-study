...
<HTML>
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/servlet/AdminServlet" method="post" enctype="multipart/form-data">
			&nbsp;
			<input type="hidden" name="method" value="addPro">
