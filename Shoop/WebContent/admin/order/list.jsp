...
<HTML>
	...
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
			<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
				<TBODY>
					...
					<tr>
						<td class="ta_01" align="center" colspan="6" cbgColor="#afd1f3">
							<input type="button" value="生成报表" class="createExcel" onclick="createExcelInfo()"/>
						</td>
					</tr>
					<tr>
		...
		<script type="text/javascript">
				function createExcelInfo(){
					window.location.href="${pageContext.request.contextPath}/servlet/AdminServlet?method=createExcel";
				};
				//点击按钮查询某个订单的详情
