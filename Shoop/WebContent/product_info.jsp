...
<script type="text/javascript">
	...
	function addCart(){
		var hf="<%=request.getContextPath()%>/servlet/CartItemServlet";
		window.location.href=hf+"?method=saveCartItem&count="+$("#buyNum").val()+"&price="+$("#price").val()+"&pid="+$("#pid").val();
	}
		...
		<div class="row">
			...
			<div style="width: 950px; margin: 0 auto;">
				<div
				 ...
				 <div>
                      <c:forEach items="${onePro.prodetail}" var="detail">
                        <img src="${pageContext.request.contextPath }/${detail.imagepath}">
                      </c:forEach>
				</div>
